...
const DragonCursor = () => {
  ...
  screen.innerHTML = ""; // 🧹 Bersihkan elemen lama!
      ...
      <svg width="100%" height="100%">
        <defs>
          <g id="Cabeza" transform="matrix(1, 0, 0, 1, 0, 0)">
            <path
              style={{ fill: "#ffaa00", fillOpacity: 1 }}
            ...
            />
            <path
              style={{ fill: "#560600", fillOpacity: 1 }}
          ...
          <g id="Aletas" transform="matrix(1, 0, 0, 1, 0, 0)">
            ...
            >
              <stop
                offset="0"
                style={{ stopColor: "#f65656", stopOpacity: 1 }}
              />
              <stop
                offset="1"
          ...
          <g id="Espina" transform="matrix(1, 0, 0, 1, 0, 0)">
            ...
            >
              <stop
                offset="0"
                style={{ stopColor: "#8b0a00", stopOpacity: 1 }}
              />
              <stop
                offset="1"
                style={{ stopColor: "#ff6459", stopOpacity: 1 }}
              />
            </linearGradient>
            <path
